    ...
    describe('Bike Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/bikes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Bike', () => {
                service.create(new Bike(null)).subscribe(received => {
            ...
            it('should update a Bike', () => {
                service.update(new Bike(123)).subscribe(received => {
