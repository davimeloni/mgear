...
export class BikeService {
    ...
    private resourceUrl2 = SERVER_API_URL + 'api/bikescsv';
    ...
    saveCSV(bikes: IBike[]): Observable<EntityArrayResponseType> {
        return this.http.post<IBike[]>(this.resourceUrl2, bikes, { observe: 'response' });
    }
}
